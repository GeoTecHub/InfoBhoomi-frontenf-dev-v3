...
import { BuildingTabV2Component } from './building-tab-v2/building-tab-v2.component';
...
import { LandTabV2Component } from './land-tab-v2/land-tab-v2.component';
...
export class SidePanelComponent {
  ...
  readonly useV2SidePanelTabs = !!environment.USE_SIDE_PANEL_V2_TABS;
